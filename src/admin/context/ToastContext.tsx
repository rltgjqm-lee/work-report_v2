    ...
    <ToastContext.Provider value={value}>
      ...
      <div className="fixed bottom-5 right-5 z-[10000] flex flex-col gap-2.5 pointer-events-none">
        {toasts.map((toast) => (
          <div
            key={toast.id}
            className="min-w-[260px] max-w-[420px] bg-text-strong text-white text-[15px] font-semibold leading-snug pl-4 pr-5 py-3.5 rounded-[6px] shadow-xl border-l-[4px] border-l-admin-status-ok-text"
          >
            {toast.message}
          </div>
        ))}
