...
export const btnPrimaryClass =
  "border-none px-4 py-2.5 text-[13px] font-semibold rounded-[2px] cursor-pointer bg-[#1e3a5f] text-white hover:brightness-110";
export const btnGhostClass =
  "border border-[#d7dbe1] px-4 py-2.5 text-[13px] font-semibold rounded-[2px] cursor-pointer bg-white text-[#374151] hover:bg-[#f5f6f8]";
