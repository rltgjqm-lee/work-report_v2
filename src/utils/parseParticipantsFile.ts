...
const parseXlsx = async (file: File): Promise<ParsedParticipantRow[]> => {
...
const parseCsv = async (file: File): Promise<ParsedParticipantRow[]> => {
  ...
  for (const line of lines) {
    ...
    const [, name, demandName, phone] = cells;
