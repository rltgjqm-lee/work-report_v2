...
// 출근부 (역량활용) — 참여자별 일자별 출근/결근/공휴일/주말 + 서명 이미지(base64).
...
// 근무 스케줄표 (역량활용) — 근로계약서에 첨부하는 월별 근무일/휴무일 캘린더.
...
// 급여 명세서 (역량활용) — 4대보험만 자동 계산하고 나머지(주휴수당/연차수당/기타수당/
...
// 급여대장 (역량활용) — 실제 서식(work-report-v4/서식(1)/역량활용/2026ESG 급여대장.xlsx
